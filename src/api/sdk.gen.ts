 ...
 */
export const getBlockList = <ThrowOnError extends boolean = false>(options?: Options<GetBlockListData, ThrowOnError>) => (options?.client ?? client).get<GetBlockListResponses, GetBlockListErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/block',
    ...options
});
 ...
 */
export const getCommentList = <ThrowOnError extends boolean = false>(options?: Options<GetCommentListData, ThrowOnError>) => (options?.client ?? client).get<GetCommentListResponses, GetCommentListErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/comment',
    ...options
});
 ...
 */
export const getContentList = <ThrowOnError extends boolean = false>(options?: Options<GetContentListData, ThrowOnError>) => (options?.client ?? client).get<GetContentListResponses, GetContentListErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/content',
    ...options
});
 ...
 */
export const getDocumentList = <ThrowOnError extends boolean = false>(options?: Options<GetDocumentListData, ThrowOnError>) => (options?.client ?? client).get<GetDocumentListResponses, GetDocumentListErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/document',
    ...options
});
 ...
 */
export const getLabelList = <ThrowOnError extends boolean = false>(options?: Options<GetLabelListData, ThrowOnError>) => (options?.client ?? client).get<GetLabelListResponses, GetLabelListErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/label',
    ...options
});
 ...
 */
export const getNoteLabelList = <ThrowOnError extends boolean = false>(options?: Options<GetNoteLabelListData, ThrowOnError>) => (options?.client ?? client).get<GetNoteLabelListResponses, GetNoteLabelListErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * Get a list of notes
 */
export const getNoteList = <ThrowOnError extends boolean = false>(options?: Options<GetNoteListData, ThrowOnError>) => (options?.client ?? client).get<GetNoteListResponses, GetNoteListErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/note',
    ...options
});
 ...
 */
export const getPersonList = <ThrowOnError extends boolean = false>(options?: Options<GetPersonListData, ThrowOnError>) => (options?.client ?? client).get<GetPersonListResponses, GetPersonListErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/person',
    ...options
});
 ...
 */
export const getReferenceList = <ThrowOnError extends boolean = false>(options?: Options<GetReferenceListData, ThrowOnError>) => (options?.client ?? client).get<GetReferenceListResponses, GetReferenceListErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getSequenceDocumentList = <ThrowOnError extends boolean = false>(options?: Options<GetSequenceDocumentListData, ThrowOnError>) => (options?.client ?? client).get<GetSequenceDocumentListResponses, GetSequenceDocumentListErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getSequenceList = <ThrowOnError extends boolean = false>(options?: Options<GetSequenceListData, ThrowOnError>) => (options?.client ?? client).get<GetSequenceListResponses, GetSequenceListErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/sequence',
    ...options
});
